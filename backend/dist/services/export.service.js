...
exports.exportManifestPdf = exportManifestPdf;
exports.exportManifestExcel = exportManifestExcel;
const pdfkit_1 = __importDefault(require("pdfkit"));
const exceljs_1 = __importDefault(require("exceljs"));
const boarding_service_1 = require("./boarding.service");
const config_1 = require("../config");
async function exportManifestPdf(tripId, res) {
    ...
    doc
        .fontSize(24)
        .font('Helvetica', 'bold')
        .text(config_1.config.app.name, { align: 'center' })
        .moveDown(0.5);
    doc
        .fontSize(16)
        .font('Helvetica')
...
async function exportManifestExcel(tripId, res) {
    const manifest = await (0, boarding_service_1.getManifest)(tripId);
    ...
    worksheet.getCell('A1').value = `${config_1.config.app.name} - Passenger Manifest`;
